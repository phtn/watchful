    ...
    <section className='relative overflow-hidden rounded-xs border-t border-white/12 bg-[#1F2020] p-5 text-white'>
      ...
      <div className='relative'>
        <div className='flex items-start justify-between gap-4'>
          ...
          <div
            className={cn(
              `flex items-center justify-center font-medium text-xs text-center rounded-full border border-emerald-300/25 bg-emerald-300/10 h-12 w-auto aspect-square uppercase text-emerald-100 ${getNumberTone(latestSpin?.winningNumber)} border-3! border-white/15 shadow-inner`,
